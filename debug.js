...
function renderDebugPanel() {
    ...
    card.insertAdjacentHTML("beforeend", `<p>Carte ${mapData.mapId} · ${mapData.buildings.length} bâtiments · ${mapData.navigation.connections.length} arêtes · chemin invalide : ${[...game.employees, ...customers].some(e => e.pathBlocked) ? "oui" : "non"}</p>`);
