...
const DEBUG = false;
const GAME_CONFIG = Object.freeze({ startingMoney: 1000, startingProductStock: 10, dayDuration: 720, maxFrameSeconds: .1, autosaveSeconds: 30, zoomMin: .75, zoomMax: 2.5 });
...
const EMPLOYEE_OPERATION = Object.freeze({
    ...
    DEPOSITING: "DEPOSITING", DONE: "DONE", BLOCKED: "BLOCKED", MANUAL_ORDER: "MANUAL_ORDER"
});
// Facteur commun appliqué aux vitesses historiques des employés et clients.
const PEDESTRIAN_SPEED_MULTIPLIER = 1.7;
const EMPLOYEE_WALK_SPEED = 10 * PEDESTRIAN_SPEED_MULTIPLIER;
